...
function C_SOURCES_HEADER_SUMMARIES(props) {
	...
	const lc 						= WH.locales.GET(p.lang, 'content.source');
	...
	return (p.mode === "summaries") ? ( 
		...
		<div className="control_row_summaries sources_control_summaries">
...
module.exports = C_SOURCES_HEADER_SUMMARIES;