...
function C_INVESTORS_HEADER_COLUMN(props) {
	...
	return ( 
		...
		<div className="header_row column_row investors_column">
			...
			<div className="hell hell_address" title={l.address_hint} >				<C.ORDERING_COLUMN_CELL props={{column: 'address', text: l.address, filter, set_filter, section}} /></div>
...
module.exports = C_INVESTORS_HEADER_COLUMN;