...
function C_INVESTORS_HEADER_FILTER(props) {
	...
	return ( 
		...
		<div className="header_row filter_row investors_filter">
			...
			<div className="hell hell_address">			<C.FILTER_TEXT 		props={{section, column: 'address', local_filter, set_local_filter}} /></div>
...
module.exports = C_INVESTORS_HEADER_FILTER;