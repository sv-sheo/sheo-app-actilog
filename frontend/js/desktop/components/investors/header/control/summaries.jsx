...
function C_INVESTORS_HEADER_SUMMARIES(props) {
	...
	const lc 						= WH.locales.GET(p.lang, 'content.investor');
	...
	return (p.mode === "summaries") ? ( 
		...
		<div className="control_row_summaries investors_control_summaries">
...
module.exports = C_INVESTORS_HEADER_SUMMARIES;