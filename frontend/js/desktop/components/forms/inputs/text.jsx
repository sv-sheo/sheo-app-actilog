...
function C_FORMS_INPUTS_TEXT(props) {
	...
	var classes	= {
		...
		text:	"fr_input_text fr_input_text_"+section,
	...
	return ( 
		...
		<div className={classes.row}>
			...
			<div className={classes.input}>
				...
				<input className={classes.text} type={input.type} required={req} minLength={min} maxLength={max} name={input.name} value={value} onChange={handle_change} />
...
module.exports = C_FORMS_INPUTS_TEXT;