...
function C_FORMS_INPUTS_TEXTAREA(props) {
	...
	var classes	= {
		...
		text:	"fr_input_textarea fr_input_textarea_"+section,
	...
	return ( 
		...
		<div className={classes.row}>
			...
			<div className={classes.input}>
				...
				<textarea className={classes.text} type={input.type} required={req} minLength={min} maxLength={max} name={input.name} value={value} onChange={handle_change}></textarea>
...
module.exports = C_FORMS_INPUTS_TEXTAREA;